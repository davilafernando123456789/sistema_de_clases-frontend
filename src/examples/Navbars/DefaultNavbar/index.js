...
function DefaultNavbar({ brand, routes, transparent, light, action, sticky, relative, center }) {
  ...
  const renderNavbarItems = routes.map(({ name, icon, href, route, collapse }) => {
    let iconName = icon; // Suponiendo que icon es una cadena
    // Si icon es un objeto u otro tipo de datos, extrae el nombre según sea necesario
    // Ejemplo: si icon es un objeto { name: 'home' }, extrae el nombre
    ...
    return (
      <DefaultNavbarDropdown
        ...
        light={light}
      >
        {/* Pasa iconName al componente Icon */}
        <Icon>{iconName}</Icon>
      </DefaultNavbarDropdown>
    );
  });
